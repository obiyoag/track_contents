...
{% include figure.liquid loading="eager" path="/assets/img/whs.png" class="img-fluid" zoomable=true caption="Figure 1." %}

This track will feature **206** three-dimensional cardiac images, utilized in real clinical settings, encompassing the entire heart. The dataset includes **104 CT** and **102 MRI** volumes, sourced globally from **6** imaging centers. 

The objective of this track is to achieve precise segmentation of seven substructures of the whole heart, with robustness against domain shifts (see Fig. 1).  It offers an open and equitable platform for various research groups to test and validate their methodologies on the clinically sourced datasets.

Outstanding contributions will be recognized with awards, similar to [MM-WHS 2017](https://zmiclab.github.io/zxh/0/mmwhs/)<d-cite key="whs3"></d-cite> . Submissions will be evaluated based on the novelty of their methodologies, the quality of the manuscript, the clarity of their presentation, and their empirical results.
...
The WHS++ track challenges participants to segment seven specific cardiac substructures, each associated with a unique label value:
